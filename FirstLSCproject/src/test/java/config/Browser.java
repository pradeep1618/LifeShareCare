...
public class Browser {
		...
		@BeforeSuite
		public void repos(){
			htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir")+"/Records/LSCtestHtmlReports.html");
			extent=new ExtentReports();
			extent.attachReporter(htmlReporter);
			extent.setSystemInfo("LifeShareCare", "Test Environment");
			extent.setSystemInfo("Host Name", "Pradeep K Reddy");
			
			htmlReporter.config().setDocumentTitle("LifeShareCare Test Result");
